...
import { BlogContent, BlogTitleCard, BlogParagraphTitle, BlogCard, BlogCardBody, BlogCardHeader, BlogImage, BlogParagraph, BlogTag, BlogTitle, BlogButtom, BlogParagraphPubli, BlogParagraphSpan} from './Styles/BlogElements'
...
// }, [])
  ...
  return (
    ...
    <BlogContent>
      ...
      <BlogParagraphTitle>
        In this blog you will find topics, articles, guides, projects related to programming and web design. We will be talking about Html, Css, JavaScript, Photoshop, Illustrator, Figma and other topics.
      </BlogParagraphTitle>
      ...
      <BlogCard>
          ...
          <BlogCardBody>
            ...
            <BlogParagraphPubli>
              Published: <BlogParagraphSpan>Friday, January, 14th, 2022.</BlogParagraphSpan>
            </BlogParagraphPubli>
            <BlogButtom to=''>
              <b>See More</b>
            </BlogButtom>
        ...
        <BlogCard>
          <BlogCardHeader>
            <BlogImage src={imgCss}/>
          </BlogCardHeader>
          <BlogCardBody>
            <BlogTag>Css</BlogTag>
            <BlogTitleCard>Interview questions</BlogTitleCard>
            <BlogParagraph>
              This article covers the most frequently asked CSS and CSS3 interview questions.
        ...
        <BlogCard>
          ...
          <BlogCardBody>
            ...
            <BlogTitleCard>Interview questions</BlogTitleCard>
            <BlogParagraph>
            JavaScript interview questions, which are likely to be asked during the interview. 
        ...
        <BlogCard>
          <BlogCardHeader>
            <BlogImage src={imgPhot}/>
          </BlogCardHeader>
          <BlogCardBody>
            <BlogTag>Photoshop</BlogTag>
            <BlogTitleCard>Must-Know Shortcuts</BlogTitleCard>
            <BlogParagraph>
              These are commands that are easy to pull off, and they will certainly speed up your productivity.
        ...
        <BlogCard>
          ...
          <BlogCardBody>
            ...
            <BlogTitleCard>Must-Know Shortcuts</BlogTitleCard>
            <BlogParagraph>
              These shortcuts for handling layers, text and more are guaranteed to speed your productivity!
        ...
        <BlogCard>
          <BlogCardHeader>
            <BlogImage src={imgFig}/>
          </BlogCardHeader>
          <BlogCardBody>
            <BlogTag>Figma</BlogTag>
            <BlogTitleCard>Figma plugins</BlogTitleCard>
            <BlogParagraph>
              Figma plugins are a recent addition to what's becoming the go-to collaborative tool for the designers.
        ...
        <BlogCard>
          <BlogCardHeader>
            <BlogImage src={imggithub}/>
          </BlogCardHeader>
          <BlogCardBody>
            <BlogTag>GITHUB</BlogTag>
            <BlogTitleCard>10 Common Git Commands Everyone Should Know</BlogTitleCard>
            <BlogParagraph>
        ...
        <BlogCard>
          ...
          <BlogCardBody>
            ...
            <BlogParagraph>
              In this article, you will find information about topics basic in English.
            </BlogParagraph>
            <BlogParagraphPubli>
              Published: <BlogParagraphSpan>Friday, January, 14th, 2022.</BlogParagraphSpan>
            </BlogParagraphPubli>
